 ...
 */
class CRM_kid_CivirulesAction_Form_PdfKid extends CRM_Core_Form {
  ...
  function buildQuickForm() {
    ...
    $this->add('text', 'to_email', ts('To e-mail address'), true);
  ...
  public function setDefaultValues() {
    ...
    if (!empty($data['earmarking'])) {
      $defaultValues['earmarking'] = $data['earmarking'];
    }
    if (!empty($data['aksjon_id'])) {
      $defaultValues['aksjon_id'] = $data['aksjon_id'];
    }
  ...
  public function postProcess() {
    ...
    $data['aksjon_id'] = $this->_submitValues['aksjon_id'];
    $data['earmarking'] = $this->_submitValues['earmarking'];
